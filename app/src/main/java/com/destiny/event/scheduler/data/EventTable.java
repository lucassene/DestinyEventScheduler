...
public class EventTable {
    ...
    public static void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("INSERT INTO " + TABLE_NAME + "(" + COLUMN_ID + ", " + COLUMN_EN + ", " + COLUMN_PT + ", " + COLUMN_ES + ", " + COLUMN_ICON + ", " + COLUMN_TYPE + ", " + COLUMN_LIGHT + ", " + COLUMN_GUARDIANS  + ")" + " VALUES " + "(null, 'Patrol the Plaguelands', 'Patrulhe as Terras Pestíferas', 'Patrulla las Tierras Pestíferas', 'ic_patrol', '3', '5', '3');");
