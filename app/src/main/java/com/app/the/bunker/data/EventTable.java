...
public class EventTable {
    ...
    public static void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("INSERT INTO " + TABLE_NAME + "(" + COLUMN_ID + ", " + COLUMN_EN + ", " + COLUMN_PT + ", " + COLUMN_ES + ", " + COLUMN_ICON + ", " + COLUMN_TYPE + ", " + COLUMN_LIGHT + ", " + COLUMN_GUARDIANS  + ")" + " VALUES " + "(null, 'Taken War: Heroic', 'Guerra dos Possuídos: Heroico', 'Guerra de los Possuídos: Heroico', 'ic_strike', '8', '260', '3');");
